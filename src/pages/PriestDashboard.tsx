  ...
  return (
    <div className="container max-w-4xl py-12">
      <div className="flex items-center gap-3 mb-8">
        <h1 className="text-3xl font-bold" style={{ color: "#2B2B2B" }}>Priest Dashboard</h1>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            <Label>Bio / Services Offered</Label>
      ...
      <Card className="mt-6">
        <CardHeader>
          <CardTitle>Pooja Bookings</CardTitle>
        </CardHeader>
        <CardContent>
          {bookingsLoading ? (
            <p className="text-muted-foreground text-sm">Loading bookings...</p>
          ) : bookings.length === 0 ? (
            <p className="text-muted-foreground text-sm">No pooja bookings available.</p>
          ) : (
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>Pooja Type</TableHead>
                ...
                <TableBody>
                  {bookings.map((b) => (
                    <TableRow key={b.id}>
                      ...
                      <TableCell>{b.pooja_type || "—"}</TableCell>
